package com.andres.gestion_usuarios_api.security;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        nombre = jwtService.extraerNombreUsuario(token);

        if (nombre != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UsuarioEntity usuario = usuarioRepository.findByNombre(nombre).orElse(null);
